...
[English](README.zh-EN.md) | [简体中文](README.md)
...
# 手动触发汇率更新
curl -X POST http://localhost:3001/api/exchange-rates/update \
...
### 💻 开发文档
- **[开发文档中心](docs/开发文档中心.md)** - 技术架构、API接口和开发指南
...
详细的数据库设计请参考：[开发文档中心](docs/开发文档中心.md)
